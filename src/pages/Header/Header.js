...
const Header = () => {
   ...
   return (
      <div className='navBorder header-container '>
         <Navbar expand="lg" variant="dark"style={{backgroundColor:'#1a0000'}} className=" bg-gradient
    
">
    <br/>
            <Container>
               <Navbar.Brand as={Link} to="/home"><img width="75px" src={logo} alt="" />Workout Zone</Navbar.Brand>
               <Navbar.Toggle />
